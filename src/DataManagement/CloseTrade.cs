...
public static class CloseTrade
{
    ...
    public static void Request(PriceObj priceObj, TradeHistoryObject tradeHistoryObj){   
        ...
        // System.Console.WriteLine("Closed trade for " + priceObj.symbol + " " + tradeHistoryObj.profit + " " + tradeHistoryObj.direction + " " + tradeHistoryObj.level + " " + tradeHistoryObj.closeLevel);
